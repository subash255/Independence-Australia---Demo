    ...
    <div class="flex flex-1">
        ...
        <div class="w-full md:w-3/4 lg:w-4/5 bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST">
                ...
                <!-- Submit Button -->
                <button type="submit" class="w-full py-3 mt-4 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                    Update Profile
                </button>
            </form>
        </div>
