...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="container mx-auto p-4">
            ...
            <div class="border-b border-gray-300 pb-4">
                <ul class="flex space-x-6 justify-center md:justify-start border-b-2 mb-6">
                    ...
                    <li class="pb-2 text-xl font-semibold text-gray-600 cursor-pointer" id="shipping-returns-tab">
                        <a href="javascript:void(0)" class="hover:text-blue-600 transition duration-300">Shipping &
                            Returns</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex flex-col md:flex-row mt-6 space-y-4 md:space-y-0 md:space-x-8">
                <!-- Left Section: Description and Specifications -->
                <div class="md:w-2/3 bg-white p-6 rounded-lg" id="description-section">
                    ...
                    <!-- Specifications (only shown in Description tab) -->
                    <div id="specifications-section" class="mt-8">
            ...
            <div id="shipping-returns-section" class="md:w-2/3 mt-8 hidden">
                <p class="text-gray-700">Here are the shipping and return policies for this product.</p>
            </div>
        ...
        <script>
            ...
            const shippingReturnsTab = document.getElementById('shipping-returns-tab');

            const descriptionSection = document.getElementById('description-section');
            const reviewsSection = document.getElementById('reviews-section');
            const shippingReturnsSection = document.getElementById('shipping-returns-section');
            ...
            function setActiveTab(activeTab, activeSection) {
                ...
                shippingReturnsSection.classList.add('hidden');
                ...
                shippingReturnsTab.classList.remove('border-b-2', 'border-blue-500', 'text-blue-600');
                descriptionTab.classList.add('text-gray-600');
                reviewsTab.classList.add('text-gray-600');
                shippingReturnsTab.classList.add('text-gray-600');
            ...
            shippingReturnsTab.addEventListener('click', function() {
                setActiveTab(shippingReturnsTab, shippingReturnsSection);
            });
