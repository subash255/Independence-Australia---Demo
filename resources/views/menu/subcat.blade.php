...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800">{{ $subcategory->name }}</h1>
                            ...
                            <a href="{{ route('menu.index', $category->slug) }}">
                                <button
                                    class="w-full text-left font-semibold text-gray-700 
                                        {{ request()->segment(2) == $category->slug ? 'bg-blue-600 text-white' : 'bg-gray-100 hover:bg-gray-200' }} 
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('menu.subcat', [$category->slug, $subcategory->slug]) }}">
                                            <span class="text-gray-600 
                                                {{ request()->segment(2) == $category->slug && request()->segment(3) == $subcategory->slug ? ' text-blue-500 font-bold' : '' }}">
