    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">
                Alwayson Medical offers a comprehensive range of Daily Living and Mobility Aids, designed to support
                individuals of all ages, including children, seniors, and people with disabilities.
            </p>
        </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mb-4 gap-6">
                    @if ($subcategories->isNotEmpty())
                        @foreach ($subcategories as $subcategory)
                            <!-- Wrap the entire div with the anchor tag -->
                            <a href="{{ route('menu.subcat', [$cat->slug, $subcategory->slug]) }}" class="block">
                                <div class="bg-white shadow rounded-md p-4 cursor-pointer subcategory-btn">
                                    <h3 class="text-lg font-semibold text-gray-800">{{ $subcategory->name }}</h3>
                                    <p class="text-gray-600 mt-2">
                                        Discover a wide selection of clothing and dressing aids designed to promote
                        ...
                        @foreach ($products as $product)
                            <a href="{{ route('product.show', ['slug' => $product->slug ?: $product->id]) }}"
                                ...
                                <div
                                    ...
                                    <div
                                        class="h-48 flex items-center justify-center bg-gray-100 rounded-lg mb-2 overflow-hidden">
                                    ...
                                    <div class="flex flex-col justify-between items-center text-center h-full">
                                        <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ optional($product)->name }}
                                        </h3>
                                        ...
                                        <form action="{{ route('user.cart.add', $product->id) }}" method="POST">
                                            @csrf
                                            <button type="submit"
                                                class="inline-block bg-white border-2 border-blue-500 text-blue-500 font-lg font-bold px-4 py-2 rounded-[24px] hover:bg-blue-700 hover:text-white transition-colors mt-2">
                                                Add to Basket
                                            </button>
                                        </form>
                                    </div>
