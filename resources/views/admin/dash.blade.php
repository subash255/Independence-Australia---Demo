...
<!-- Header Section -->
<div class="bg-red-600 text-white flex items-center justify-between px-8 py-8 fixed top-0 left-[255px] right-0 shadow-lg">  
    <h1 class="text-3xl font-bold ml-50 py-0">Dashboard</h1>
...
<!-- Cards Section-->
<div class="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pt-24 px-6 mt-[-2rem]">
  <!-- Pending Orders Card -->
  <div class="bg-white p-6 text-left hover:shadow-2xl flex flex-row items-center justify-between w-full h-20 rounded-lg shadow-lg">
    <div>
  ...
  <div class="bg-white p-6 rounded-lg text-left hover:shadow-2xl transition-shadow duration-300 flex flex-row items-center justify-between w-full h-20 shadow-lg">
    <div>
